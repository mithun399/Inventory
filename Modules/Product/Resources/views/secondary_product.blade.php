        ...
        <div class="row">
            ...
            <div style="width:95% !important; margin-left:5%; margin-top:6%;">
                <div class="col-11 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" align="center">ADD SECONDARY PRODUCT</h4>
                            <form class="form-sample" action="{{url('secondary_store')}}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-6 col-form-label"></label>
                                        <div class="col-sm-9">
                                            @foreach($secondary as $pro)
                                            <input type="hidden" name="secondary_product_id" class="form-control"
                                                value="{{$pro->id+1}}">
                                            @endforeach
                                        </div>
                                    </div>
