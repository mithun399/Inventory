...
$(function() {
    // jQuery methods go here...
    $('#purchase_quantity').on("change", function() {
        calculatePrice();
    });
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside
        ...
        Vendor
        <i class="fa fa-caret-down" style="margin-left: 5%;"></i>
        </button>
        <div class="dropdown-container">
            ...
            <a class="nav-link " href="{{url('show')}}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-user-friends text-warning text-sm opacity-10"></i>
                </div>
        ...
        <button class="dropdown-btn nav-link"
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        <i class="fa fa-list-alt text-info text-sm opacity-10"></i>
        Category
        <i class="fa fa-caret-down" style="margin-left: 5%;"></i>
        </button>
        <div class="dropdown-container">
            ...
            <a class="nav-link " href="{{'category_show'}}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa fa-list-alt text-info text-sm opacity-10"></i>
                </div>
        ...
        <div class="dropdown-container">
            ...
            <a class="nav-link " href="{{'product_show'}}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa fa-briefcase text-success text-sm opacity-10"></i>
                </div>
       ...
       Secondary Product
        ...
        <div class="dropdown-container">
            <a class="nav-link " href="{{url('secondary_product')}}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa fa-product-hunt text-success text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Add Secondary Product</span>
                    </a>
                    <a class="nav-link " href="{{url('product_map')}}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa fa-product-hunt text-success text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Product Mapping</span>
                    </a>
        </div>
        </li> 
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{url('purchase')}}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="far fa-credit-card text-danger text-sm opacity-10"></i>
                        </div>
    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        <footer class="footer pt-3" style="margin-top: 75% !important;">
